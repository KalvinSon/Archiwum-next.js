...
const defaultSuggestionsData = [
  {
    category: 'Popularne Wyszukiwania',
    suggestions: [
      {
        suggestion: 'Jak uzyskać dofinansowanie',
        link: '/dashboards/crm/',
      },
      {
        suggestion: 'Ile to kosztuje',
        link: '/dashboards/crm/',
      },
      {
        suggestion: 'Czy każdy wniosek jest akceptowany',
        link: '/dashboards/crm/',
      },
      {
        suggestion: 'Ile trwa rozpatrzenie wniosku',
        link: '/dashboards/crm/',
      },
    ]
  },
  {
    category: 'Najpopularniejsze w FAQ',
    suggestions: [
      {
        suggestion: 'Jakie warunki trzeba spełnić',
        link: '/dashboards/crm/',
      },
      {
        suggestion: 'Czy muszę posiadać firmę',
        link: '/dashboards/crm/',
      },
      {
        suggestion: 'Czy sprawdzany jest BIK',
        link: '/dashboards/crm/',
      },
      {
        suggestion: 'Kiedy otrzymam pieniądze',
        link: '/dashboards/crm/',
      }
    ]
  },
    ...
    return (
      ...
      >
        ...
        {!hidden && layout === 'vertical' ? (
          <Typography sx={{ color: 'text.disabled' }}>Szukaj w serwisie...</Typography>
        ) : null}

          ...
          <ScrollWrapper hidden={hidden}>
            {store && store.mails && store.mails.length ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {routeParams && routeParams.folder !== 'trash' ? (
                            <Tooltip placement='top' title='Usuń wiadomość'>
                              <IconButton
                                onClick={e => {
                                  e.stopPropagation()
                          ...
                          <Tooltip placement='top' title={mail.isRead ? 'Oznacz jako odczytane' : 'Oznacz jako odczytane'}>
                            <IconButton
                              onClick={e => {
                                e.stopPropagation()
                        ...
                        >
                          ...
                          >
                            {new Date(mail.time).toLocaleTimeString('pl-PL', {
                              hour: '2-digit',
                              minute: '2-digit',
                              hour12: true
                            })}
              ...
              <Box sx={{ mt: 6, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Typography>Skrzynka jest pusta</Typography>
              </Box>
            )}
          </ScrollWrapper>
          <Backdrop

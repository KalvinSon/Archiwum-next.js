...
const ComposePopup = props => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography sx={{ fontWeight: 600, color: 'text.secondary' }}>Napisz Wiadomość</Typography>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <ButtonGroup variant='contained' ref={anchorRefSendBtn} aria-label='split button'>
            <Button onClick={handlePopupClose}>Wyślij</Button>
            <Button
              size='small'
              aria-haspopup='true'
          ...
          >
            <MenuItem onClick={handleSendMenuItemClick}>Zapisz jako szkic</MenuItem>
          </Menu>

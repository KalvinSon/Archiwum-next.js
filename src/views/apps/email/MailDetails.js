          ...
          <Box sx={{ height: 'calc(100% - 7.75rem)', backgroundColor: theme => theme.palette.action.hover }}>
            <ScrollWrapper>
              ...
              >
                        ...
                        >
                          ...
                          {reply.attachments.length ? (
                            <Fragment>
                              <Divider sx={{ m: 0 }} />
                              <Box sx={{ p: 5 }}>
                                <Typography variant='body2'>Załączniki</Typography>
                                <List>
                ...
                >
                  <Typography component='span' sx={{ cursor: 'pointer', color: 'primary.main', fontWeight: 'inherit' }}>
                    Kliknij by odpowiedziedź na tę wiadomość
                  </Typography>
                </Box>
              </Box>
            </ScrollWrapper>
